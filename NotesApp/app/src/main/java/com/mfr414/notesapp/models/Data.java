...
public class Data {
    ...
    static {
        users = new ArrayList<>();
        users.add(new User("adi","rahasia",0));
        users.add(new User("beni","rahasialah",1));
        users.add(new User("cindy","rahasialoh",0));
        users.add(new User("kiki","rahasianih",1));
        ...
        notes.add(new Note("Note 5", new Date(), "Soto, Sate, Bakso, Siomay, Gorengan, Mie Instan, Tempe Penyet, Ayam Geprek."));
