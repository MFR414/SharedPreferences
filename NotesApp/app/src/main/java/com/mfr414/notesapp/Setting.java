...
public class Setting {
    ...
    public void setUser(String user){
        preferences.edit().putString(Constant.SESSION,user).apply();
    }
    ...
    public void setLayoutMode(int layout){
        preferences.edit().putInt(Constant.LAYOUT_MODE,layout).apply();
    }
    ...
    public void setTextSize(String size){
        preferences.edit().putString(Constant.PREF_TEXT_SIZE,size).apply();
    }
}
